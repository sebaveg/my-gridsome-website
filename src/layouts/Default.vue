    ...
    <header class="border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        >
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            <a v-if="$route.path === '/'" href="/#projects" v-scroll-to="'#projects'" class="text-copy-primary hover:text-gray-600">Proyectos</a>
            <g-link v-else to="/#projects" class="text-copy-primary hover:text-gray-600">Proyectos</g-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
            <a v-if="$route.path === '/'" href="/#about" v-scroll-to="'#about'" class="text-copy-primary hover:text-gray-600">Sobre mi</a>
            <g-link v-else to="/#about" class="text-copy-primary hover:text-gray-600">Sobre mi</g-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
            <a v-if="$route.path === '/'" href="/#contact" v-scroll-to="'#contact'" class="text-copy-primary hover:text-gray-600">Contacto</a>
            <g-link v-else to="/#contact" class="text-copy-primary hover:text-gray-600">Contacto</g-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="me@sebastiancardoso.com" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/sebaveg/my-gridsome-website" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/sebageounity" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/sebageounity" target="_blank" class="text-white hover:text-gray-400">
